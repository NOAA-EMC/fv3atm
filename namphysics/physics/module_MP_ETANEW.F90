...
!-----------------------------------------------------------------------
      ...
      INTEGER,INTENT(IN) :: IMS,IME,JMS,JME,LM,itimestep
...
!
     ...
     & THICK_col, WC_col,LM,NSTATS,QMAX,QTOT,pcond1d,pidep1d,    &
...
!
        IF(MYPE==0)THEN
          OPEN(UNIT=etampnew_unit1,FILE="DETAMPNEW_DATA_LE",            &
