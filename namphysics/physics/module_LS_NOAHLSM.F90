...
! IN only
   ...
   REAL,    DIMENSION( ims:ime, jms:jme, lm+1)                , &
            INTENT(IN   )    ::                                 &
                                                           P8w3D
   REAL,    DIMENSION( ims:ime, jms:jme, lm)                  , &
            INTENT(IN   )    ::                                 &
...
! input variables surface_driver --> lsm
     ...
     REAL, OPTIONAL, DIMENSION( ims:ime, jms:jme, 1:lm  ), INTENT(IN) :: U_PHY
     REAL, OPTIONAL, DIMENSION( ims:ime, jms:jme, 1:lm  ), INTENT(IN) :: V_PHY
...
! pressure in middle of lowest layer
        SFCPRS=(P8W3D(I,j,LM)+P8W3D(i,j,LM+1))*0.5
         Q2K=Q3D(i,j,LM)
         Q2SAT=QGH(I,j)
...
!                                                                       
       ...
       CALL SFLX (FFROZP, ICE,DT,ZLVL,NSOIL,SLDPTH,               &    !C
                 ...
                 SOILW,SOILM,Q1,                                  &    !D
                 SMCWLT,SMCDRY,SMCREF,SMCMAX,NROOT,RIBB,i,j)   ! added Bulk Richardson No.
!rv              SMCWLT,SMCDRY,SMCREF,SMCMAX,NROOT,RIBB)   ! added Bulk Richardson No.
...
!
            ...
            TA_URB    = SFCTMP           ! [K]
            QA_URB    = Q2K              ! [kg/kg]
            UA_URB    = SQRT(U_PHY(I,J,LM)**2.+V_PHY(I,J,LM)**2.)
            U1_URB    = U_PHY(I,J,LM)
            V1_URB    = V_PHY(I,J,LM)
...
!------------------------------------------------------
  ...
  SUBROUTINE NOAH_LSM_INIT(IVEGSRC)
...
!-----------------------------------------------------------------
        ...
        integer :: ierr,IRTN,MYPE,rc,mpi_comm_comp
...
!
      ...
      CALL MPI_BCAST(ALBTBL      ,NLUS ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(Z0TBL       ,NLUS ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(SHDTBL      ,NLUS ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(NROTBL      ,NLUS ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(RSTBL       ,NLUS ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(RGLTBL      ,NLUS ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(HSTBL       ,NLUS ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(SNUPTBL     ,NLUS ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(LAITBL      ,NLUS ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(MAXALB      ,NLUS ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(TOPT_DATA   ,1    ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(CMCMAX_DATA ,1    ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(CFACTR_DATA ,1    ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(RSMAX_DATA  ,1    ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
...
!
      ...
      CALL MPI_BCAST(IINDEX  ,1       ,MPI_INTEGER          ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(BB      ,NSLTYPE ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(DRYSMC  ,NSLTYPE ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(F11     ,NSLTYPE ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(MAXSMC  ,NSLTYPE ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(REFSMC  ,NSLTYPE ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(SATPSI  ,NSLTYPE ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(SATDK   ,NSLTYPE ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(SATDW   ,NSLTYPE ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(WLTSMC  ,NSLTYPE ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(QTZ     ,NSLTYPE ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
!
...
!
      ...
      CALL MPI_BCAST(SLOPE_DATA  ,NSLOPE ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(SBETA_DATA  ,1      ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(FXEXP_DATA  ,1      ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(CSOIL_DATA  ,1      ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(SALP_DATA   ,1      ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(REFDK_DATA  ,1      ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(REFKDT_DATA ,1      ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(FRZK_DATA   ,1      ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(ZBOT_DATA   ,1      ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(CZIL_DATA   ,1      ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(SMLOW_DATA  ,1      ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
      CALL MPI_BCAST(SMHIGH_DATA ,1      ,MPI_DOUBLE_PRECISION ,0,MPI_COMM_COMP,IRTN)
...
! ----------------------------------------------------------------------         
                       ...
                       RC,PC,RSMIN,XLAI,RCS,RCT,RCQ,RCSOIL,             &    !O  
                       SOILW,SOILM,Q1,                                  &    !D  
                       SMCWLT,SMCDRY,SMCREF,SMCMAX,NROOT,RIBB,ii,jj)               !P  
!rv                    SMCWLT,SMCDRY,SMCREF,SMCMAX,NROOT,RIBB)               !P  
! ----------------------------------------------------------------------         
        ...
        'ALBEDO',ALBEDO,'SMC',SMC,'STC',STC,'SH2O',SH2O                          
         ...
         CALL PENMAN (SFCTMP,SFCPRS,CH,T2V,TH2,PRCP,FDOWN,T24,SSOIL,     &        
                       Q2,Q2SAT,ETP,RCH,EPSCA,RR,SNOWNG,FRZGRA,          &
                         DQSDT2,FLX2,EMISSI,SNEQV,ii,jj)                                            
!rv                      DQSDT2,FLX2,EMISSI,SNEQV)                                            
...
! ----------------------------------------------------------------------         
         ...
         IF (SNEQV  == 0.0) THEN                                                
            CALL NOPAC (ETP,ETA,PRCP,SMC,SMCMAX,SMCWLT,                  &  
                            ...
                            QUARTZ,FXEXP,CSOIL,                          &  
                            BETA,DRIP,DEW,FLX1,FLX3,VEGTYP,IVEGSRC,ii,jj)                  
!rv                         BETA,DRIP,DEW,FLX1,FLX3,VEGTYP,IVEGSRC)                  
            ETA_KINEMATIC = ETA                                                  
         ELSE                                                                    
            CALL SNOPAC (ETP,ETA,PRCP,PRCPF,SNOWNG,SMC,SMCMAX,SMCWLT,    & 
                         ...
                         VEGTYP,RIBB,SOLDN,IVEGSRC,ii,jj)
!rv                      VEGTYP,RIBB,SOLDN,IVEGSRC)
...
! ----------------------------------------------------------------------         
         ...
         IF (SHDFAC > 0.0) THEN                                               
            CALL TRANSP (ET,NSOIL,ETP1,SH2O,CMC,ZSOIL,SHDFAC,SMCWLT,     &
               CMCMAX,PC,CFACTR,SMCREF,SFCTMP,Q2,NROOT,RTDIS,VEGTYP,STC,ii,jj)
!rv            CMCMAX,PC,CFACTR,SMCREF,SFCTMP,Q2,NROOT,RTDIS,VEGTYP,STC)
            DO K = 1,NSOIL                                                       
               ETT = ETT + ET ( K )                                              
            END DO                                                               
! ----------------------------------------------------------------------         
...
! ----------------------------------------------------------------------         
      ...
      SUBROUTINE HRT (RHSTS,STC,SMC,SMCMAX,NSOIL,ZSOIL,YY,ZZ1,          &        
                       ...
                       F1,DF1,QUARTZ,CSOIL,AI,BI,CI,VEGTYP,IVEGSRC,ii,jj)
!rv                    F1,DF1,QUARTZ,CSOIL,AI,BI,CI,VEGTYP,IVEGSRC)
...
! ----------------------------------------------------------------------         
      IMPLICIT NONE                                                              
      LOGICAL              :: ITAVG 
      INTEGER, INTENT(IN)  :: NSOIL, VEGTYP, IVEGSRC,ii,jj
!rv   INTEGER, INTENT(IN)  :: NSOIL, VEGTYP, IVEGSRC
      INTEGER              :: I, K, IW
...
!rv   SUBROUTINE HSTEP (STCOUT,STCIN,RHSTS,DT,NSOIL,AI,BI,CI)                    
      SUBROUTINE HSTEP (STCOUT,STCIN,RHSTS,DT,NSOIL,AI,BI,CI,ii,jj)                    
...
! ----------------------------------------------------------------------         
      IMPLICIT NONE                                                              
      INTEGER, INTENT(IN)  :: NSOIL,ii,jj
!rv   INTEGER, INTENT(IN)  :: NSOIL
      INTEGER              :: K
...
! ----------------------------------------------------------------------         
!rv   CALL ROSR12 (CI,AI,BI,CIin,RHSTSin,RHSTS,NSOIL)                            
      CALL ROSR12 (CI,AI,BI,CIin,RHSTSin,RHSTS,NSOIL,ii,jj)                            
! ----------------------------------------------------------------------         
...
!urban
      CALL SHFLX (SSOIL,STC,SMC,SMCMAX,NSOIL,T1,DT,YY,ZZ1,ZSOIL,        &
                  ...
                  QUARTZ,CSOIL,VEGTYP,IVEGSRC,ii,jj)
!rv               QUARTZ,CSOIL,VEGTYP,IVEGSRC)
...
! ----------------------------------------------------------------------         
     ...
     &                   Q2,Q2SAT,ETP,RCH,EPSCA,RR,SNOWNG,FRZGRA,       &        
     &                   DQSDT2,FLX2,EMISSI_IN,SNEQV,ii,jj)                                                             
!rv  &                   DQSDT2,FLX2,EMISSI_IN,SNEQV)                                                             
...
!rv   LOGICAL, INTENT(IN)     :: SNOWNG, FRZGRA
...
!rv   SUBROUTINE ROSR12 (P,A,B,C,D,DELTA,NSOIL)                                  
      SUBROUTINE ROSR12 (P,A,B,C,D,DELTA,NSOIL,ii,jj)                                  
...
! ----------------------------------------------------------------------         
      ...
      INTEGER, INTENT(IN)   :: ICE, NSOIL, VEGTYP, IVEGSRC,ii,jj
!rv   INTEGER, INTENT(IN)   :: ICE, NSOIL, VEGTYP, IVEGSRC
      INTEGER               :: I
...
! ----------------------------------------------------------------------         
      IF (ICE == 1) THEN                                                       
         ...
         CALL HSTEP (STCF,STC,RHSTS,DT,NSOIL,AI,BI,CI,ii,jj)                           
!rv      CALL HSTEP (STCF,STC,RHSTS,DT,NSOIL,AI,BI,CI)                           
...
! ----------------------------------------------------------------------         
      ELSE                                                                       
         CALL HRT (RHSTS,STC,SMC,SMCMAX,NSOIL,ZSOIL,YY,ZZ1,TBOT,        &        
                    ZBOT,PSISAT,SH2O,DT,                                &        
                    BEXP,F1,DF1,QUARTZ,CSOIL,AI,BI,CI,VEGTYP,IVEGSRC,ii,jj)
!rv                 BEXP,F1,DF1,QUARTZ,CSOIL,AI,BI,CI,VEGTYP,IVEGSRC)
...
! ----------------------------------------------------------------------         
      IF ( (PCPDRP * DT) > (0.001*1000.0* (- ZSOIL (1))* SMCMAX) ) THEN
         ...
         CALL SSTEP (SH2OFG,SH2O,DUMMY,RHSTT,RHSCT,DT,NSOIL,SMCMAX,     &        
                     CMCMAX,SMCWLT,RUNOFF3,ZSOIL,SMC,SICE,AI,BI,CI,ii,jj)                  
!rv                  CMCMAX,SMCWLT,RUNOFF3,ZSOIL,SMC,SICE,AI,BI,CI)                  
         DO K = 1,NSOIL                                                          
...
! ----------------------------------------------------------------------         
!rv   CALL ROSR12 (CI,AI,BI,CIin,RHSTTin,RHSTT,NSOIL)                            
      CALL ROSR12 (CI,AI,BI,CIin,RHSTTin,RHSTT,NSOIL,ii,jj)                            
! ----------------------------------------------------------------------         
