...
!
      REAL,DIMENSION(IMS:IME,JMS:JME),INTENT(IN) :: HT,TSK             &
     &                                             ,XLAND,Z0BASE       &
     &                                             ,VEGFRC,SNOWC
!
...
!
      REAL,DIMENSION(LM) :: CWMK,PK,Q2K,QK,THEK,THK,TK,UK,VK
!
      REAL,DIMENSION(LM-1) :: EL,ELM
!
      REAL,DIMENSION(LM+1) :: ZHK
!
      REAL,DIMENSION(IMS:IME,JMS:JME) :: THSK
!
      REAL,DIMENSION(IMS:IME,JMS:JME,LM+1) :: ZINT
!
!----------------------------------------------------------------------
!**********************************************************************
!----------------------------------------------------------------------
...
!
     ...
     &               ,IMS,IME,JMS,JME,LM                               &
     &               ,I,J,ZHK(LMH+1),RIB(I,J))   ! Added Bulk Richardson No.
!
...
!----------------------------------------------------------------------
     ...
     &                 ,USTAR,Z0,Z0BASE,CT,RLMO,AKMS,AKHS,PBLH         &
...
!
!----------------------------------------------------------------------
      INTEGER,INTENT(IN) :: IMS,IME,JMS,JME,LM,I,J
!
      INTEGER,INTENT(IN) :: NTSD
!
      REAL,INTENT(IN) :: CWMLOW,PBLH,PLOW,QLOW,PSFC,SEAMASK,ZSFC       &
     &                  ,THELOW,THLOW,THS,TLOW,TZ0,ULOW,VLOW,ZSL       &
     &                  ,Z0BASE,VEGF,SNOC
!
...
!
     ...
     &       ,ZETAT,ZETAU,ZQ,ZSLT,ZSLU,ZT,ZU,TOPOTERM,ZZIL,CZETMAX,WETM
!vcw
!
!***  DIAGNOSTICS
!
