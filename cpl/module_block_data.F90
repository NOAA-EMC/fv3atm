...
contains
  ...
  subroutine block_copy_1d_to_2d_r8(destin_ptr, source_ptr, block, block_index, scale_factor)
  ...
  subroutine block_copy_1dslice_to_2d_r8(destin_ptr, source_ptr, slice, block, block_index, scale_factor)
  ...
  subroutine block_copy_2d_to_3d_r8(destin_ptr, source_ptr, block, block_index, scale_factor)
  ...
  subroutine block_copy_2d_to_2d_r8(destin_ptr, source_ptr, block, block_index, scale_factor)
  ...
  subroutine block_array_copy_2d_to_2d_r8(destin_ptr, source_arr, block, block_index, scale_factor)
  ...
  subroutine block_copy_3d_to_3d_r8(destin_ptr, source_ptr, block, block_index, scale_factor)
  ...
  subroutine block_array_copy_3d_to_3d_r8(destin_ptr, source_arr, block, block_index, scale_factor)
  ...
  subroutine block_copy_3dslice_to_3d_r8(destin_ptr, source_ptr, slice, block, block_index, scale_factor)
  ...
  subroutine block_array_copy_3dslice_to_3d_r8(destin_ptr, source_arr, slice, block, block_index, scale_factor)
  ...
  subroutine block_fill_2d_r8(destin_ptr, fill_value, block, block_index)
  ...
  subroutine block_fill_3d_r8(destin_ptr, fill_value, block, block_index)
  ...
  subroutine block_copy_or_fill_1d_to_2d_r8(destin_ptr, source_ptr, fill_value, block, block_index)
    ...
    if (associated(destin_ptr)) then
      if (associated(source_ptr)) then
        call block_copy_1d_to_2d_r8(destin_ptr, source_ptr, block, block_index)
      else
        call block_fill_2d_r8(destin_ptr, fill_value, block, block_index)
      end if
    end if
  ...
  subroutine block_copy_or_fill_1dslice_to_2d_r8(destin_ptr, source_ptr, slice, fill_value, block, block_index)
    ...
    if (associated(destin_ptr)) then
      if (associated(source_ptr)) then
        call block_copy_1dslice_to_2d_r8(destin_ptr, source_ptr, slice, block, block_index)
      else
        call block_fill_2d_r8(destin_ptr, fill_value, block, block_index)
      end if
    end if
  ...
  subroutine block_copy_or_fill_2d_to_3d_r8(destin_ptr, source_ptr, fill_value, block, block_index)
    ...
    if (associated(destin_ptr)) then
      if (associated(source_ptr)) then
        call block_copy_2d_to_3d_r8(destin_ptr, source_ptr, block, block_index)
      else
        call block_fill_3d_r8(destin_ptr, fill_value, block, block_index)
      end if
    end if
  ...
  subroutine block_combine_frac_1d_to_2d_r8(destin_ptr, fract1_ptr, fract2_ptr, block, block_index)
