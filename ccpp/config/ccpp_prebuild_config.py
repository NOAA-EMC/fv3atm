...
VARIABLE_DEFINITION_FILES = [
    ...
    'physics/physics/h2o_photo/h2o_def.f',
    'physics/physics/o3_photo/ozne_def.f',
...
SCHEME_FILES = [
    ...
    'physics/physics/Interstitials/UFS_SCM_NEPTUNE/phys_tend.F90',
    ...
    'physics/physics/h2o_photo/h2ophys.f',
    'physics/physics/o3_photo/ozphys.f',
    'physics/physics/o3_photo/ozphys_2015.f',
    ...
    'physics/physics/Radiation/RRTMG/rrtmg_lw_pre.F90',
    ...
    'physics/physics/SFC_Layer/UFS/sfc_nst_pre.f',
    'physics/physics/SFC_Layer/UFS/sfc_nst.f',
    'physics/physics/SFC_Layer/UFS/sfc_nst_post.f',
