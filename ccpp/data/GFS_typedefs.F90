...
!--- Increment grid    
    logical              :: gaussian_increment ! increment on guassian grid or else native grid
...
!--- Increment grid
    logical               :: gaussian_increment = .true. ! increment on guassian grid or else native grid
