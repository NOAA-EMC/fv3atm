...
!!
  type GFS_interstitial_type
    ...
    real (kind=kind_phys), pointer      :: adjsfculw_wat(:)   => null()  !<
    ...
    real (kind=kind_phys), pointer      :: cmm_wat(:)         => null()  !<
    ...
    real (kind=kind_phys), pointer      :: ep1d_wat(:)        => null()  !<
    ...
    real (kind=kind_phys), pointer      :: evap_wat(:)        => null()  !<
    ...
    real (kind=kind_phys), pointer      :: gabsbdlw_wat(:)    => null()  !<
    ...
    real (kind=kind_phys), pointer      :: gflx_wat(:)        => null()  !<
    ...
    real (kind=kind_phys), pointer      :: hflx_wat(:)        => null()  !<
    ...
    real (kind=kind_phys), pointer      :: qss_wat(:)         => null()  !<
    logical                             :: radar_reset                   !<
    ...
    real (kind=kind_phys), pointer      :: rb_wat(:)          => null()  !<
    logical                             :: reset                         !<
    ...
    real (kind=kind_phys), pointer      :: semis_wat(:)       => null()  !<
    ...
    real (kind=kind_phys), pointer      :: snowd_wat(:)       => null()  !<
    ...
    real (kind=kind_phys), pointer      :: stress_wat(:)      => null()  !<
    ...
    real (kind=kind_phys), pointer      :: tprcp_wat(:)       => null()  !<
    ...
    real (kind=kind_phys), pointer      :: tsfc_wat(:)        => null()  !<
    ...
    real (kind=kind_phys), pointer      :: tsurf_wat(:)       => null()  !<
    ...
    real (kind=kind_phys), pointer      :: uustar_wat(:)      => null()  !<
    ...
    real (kind=kind_phys), pointer      :: weasd_wat(:)       => null()  !<
    ...
    real (kind=kind_phys), pointer      :: zorl_wat(:)        => null()  !<
...
!-----------------------
  ...
  subroutine interstitial_create (Interstitial, IM, Model)
    ...
    allocate (Interstitial%adjsfculw_wat   (IM))
    ...
    allocate (Interstitial%cmm_wat         (IM))
    ...
    allocate (Interstitial%ep1d_wat        (IM))
    ...
    allocate (Interstitial%evap_wat        (IM))
    ...
    allocate (Interstitial%gabsbdlw_wat    (IM))
    ...
    allocate (Interstitial%gflx_wat        (IM))
    ...
    allocate (Interstitial%hflx_wat        (IM))
    ...
    allocate (Interstitial%qss_wat         (IM))
    ...
    allocate (Interstitial%rb_wat          (IM))
    ...
    allocate (Interstitial%semis_wat       (IM))
    ...
    allocate (Interstitial%snowd_wat       (IM))
    ...
    allocate (Interstitial%stress_wat      (IM))
    ...
    allocate (Interstitial%tprcp_wat       (IM))
    ...
    allocate (Interstitial%tsfc_wat        (IM))
    ...
    allocate (Interstitial%weasd_wat       (IM))
    ...
    allocate (Interstitial%zorl_wat        (IM))
...
! F-A scheme
  ...
  subroutine interstitial_phys_reset (Interstitial, Model)
    ...
    Interstitial%adjsfculw_wat   = clear_val
    ...
    Interstitial%gabsbdlw_wat    = clear_val
    ...
    Interstitial%gflx_wat        = clear_val
    ...
    Interstitial%semis_wat       = clear_val
...
!
  ...
  subroutine interstitial_print(Interstitial, Model, mpirank, omprank, blkno)
    ...
    write (0,*) 'sum(Interstitial%adjsfculw_wat   ) = ', sum(Interstitial%adjsfculw_wat   )
    ...
    write (0,*) 'sum(Interstitial%cd_wat          ) = ', sum(Interstitial%cd_wat          )
    ...
    write (0,*) 'sum(Interstitial%cmm_wat         ) = ', sum(Interstitial%cmm_wat         )
    ...
    write (0,*) 'sum(Interstitial%ep1d_wat        ) = ', sum(Interstitial%ep1d_wat        )
    ...
    write (0,*) 'sum(Interstitial%evap_wat        ) = ', sum(Interstitial%evap_wat        )
    ...
    write (0,*) 'sum(Interstitial%ffhh_wat        ) = ', sum(Interstitial%ffhh_wat        )
    ...
    write (0,*) 'sum(Interstitial%fh2_wat         ) = ', sum(Interstitial%fh2_wat         )
    ...
    write (0,*) 'sum(Interstitial%ffmm_wat        ) = ', sum(Interstitial%ffmm_wat        )
    ...
    write (0,*) 'sum(Interstitial%fm10_wat        ) = ', sum(Interstitial%fm10_wat        )
    ...
    write (0,*) 'sum(Interstitial%gabsbdlw_wat    ) = ', sum(Interstitial%gabsbdlw_wat    )
    ...
    write (0,*) 'sum(Interstitial%gflx_wat        ) = ', sum(Interstitial%gflx_wat        )
    ...
    write (0,*) 'sum(Interstitial%hflx_wat        ) = ', sum(Interstitial%hflx_wat        )
    ...
    write (0,*) 'sum(Interstitial%qss_wat         ) = ', sum(Interstitial%qss_wat         )
    ...
    write (0,*) 'sum(Interstitial%rb_wat          ) = ', sum(Interstitial%rb_wat          )
    ...
    write (0,*) 'sum(Interstitial%semis_wat       ) = ', sum(Interstitial%semis_wat       )
    ...
    write (0,*) 'sum(Interstitial%snowd_wat       ) = ', sum(Interstitial%snowd_wat       )
    ...
    write (0,*) 'sum(Interstitial%stress_wat      ) = ', sum(Interstitial%stress_wat      )
    ...
    write (0,*) 'sum(Interstitial%tprcp_wat       ) = ', sum(Interstitial%tprcp_wat       )
    ...
    write (0,*) 'sum(Interstitial%tsfc_wat        ) = ', sum(Interstitial%tsfc_wat        )
    ...
    write (0,*) 'sum(Interstitial%tsurf_wat       ) = ', sum(Interstitial%tsurf_wat       )
    ...
    write (0,*) 'sum(Interstitial%uustar_wat      ) = ', sum(Interstitial%uustar_wat      )
    ...
    write (0,*) 'sum(Interstitial%weasd_wat       ) = ', sum(Interstitial%weasd_wat       )
    ...
    write (0,*) 'sum(Interstitial%zorl_wat        ) = ', sum(Interstitial%zorl_wat        )
